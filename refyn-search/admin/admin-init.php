...
class Refyn_Search_Admin_Init extends Refyn_Search_Admin_UI
...

{
	...
	public function init() {
		...
		add_action( 'admin_notices', 'api_key_admin_notice_function' );
	...
	public function get_all_settings() {
		...
		$setting_options=get_option('refyn_all_settings');
	 ...
	 * check add_menu_page() function at https://codex.wordpress.org/Function_Reference/add_menu_page to know the parameters need to parse for type is menu



	 * check add_submenu_page() function at https://codex.wordpress.org/Function_Reference/add_submenu_page to know the parameters need to parse for type is submenu
	 ...
	 *														View instruction at https://codex.wordpress.org/Roles_and_Capabilities
	 ...
	 *		'icon_url'		=> 'https://my_icon.png'		: (optional) The url to the icon to be used for this menu.
	...
	public function admin_settings_page( $page_data = array() ) {
        ...
        <div class="wrap">
            ...
            <div class="icon32 icon32-refynrev-ui-settings icon32-refynrev<?php echo $current_page; ?>" id="icon32-refynrev<?php echo $current_page; ?>"><br /></div>
	...
	public function admin_settings_tab( $current_page = '', $tab_data = array()  ) {
        ...
        <div class="refyn_subsubsub_section">
...
$refyn_search_admin_init = new Refyn_Search_Admin_Init();



function api_key_admin_notice_function(){
	...
	if(empty($setting_options['refyn_api_key_text'])){
    ...
    <div class="error notice refyn-search-notice is-dismissible">



        <p><strong><?php _e( 'API key is missing, receive a 30 day free trial when you upgrade to the Pro version!', 'refyn-search' ); ?></strong></p>
