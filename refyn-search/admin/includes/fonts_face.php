...
-----------------------------------------------------------------------------------*/
class Refyn_Search_Fonts_Face extends Refyn_Search_Admin_UI
{
	...
	public $google_fonts = array(	array( 'name' => "Cantarell", 'variant' => ':r,b,i,bi'),
							...
							array( 'name' => "Holtrefynrevd One SC", 'variant' => ''),
							...
							array( 'name' => "Fanrefynrevd Text", 'variant' => ''),
...
global $refyn_search_fonts_face;
$refyn_search_fonts_face = new Refyn_Search_Fonts_Face();
