...
/*-----------------------------------------------------------------------------------
Refyn Search Exclude Content Tab
TABLE OF CONTENTS
- var parent_page
- var position
- var tab_data
...
- tab_manager()
-----------------------------------------------------------------------------------*/
class REFYN_Exclude_Content_Tab extends Refyn_Search_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'refyn_exclude_content_tab_manager',
		);
...
global $refyn_exclude_content_tab;
$refyn_exclude_content_tab = new REFYN_Exclude_Content_Tab();
/** 
 * admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function refyn_exclude_content_tab_manager() {
	global $refyn_exclude_content_tab;
	$refyn_exclude_content_tab->tab_manager();
}
