...
- tab_manager()
-----------------------------------------------------------------------------------*/
class Refyn_Search_Global_Settings_Tab extends Refyn_Search_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'refyn_search_global_settings_tab_manager',
		);
...
global $refyn_search_global_settings_tab;
$refyn_search_global_settings_tab = new Refyn_Search_Global_Settings_Tab();
/** 
 * admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function refyn_search_global_settings_tab_manager() {
	global $refyn_search_global_settings_tab;
	$refyn_search_global_settings_tab->tab_manager();
}
