...
- tab_manager()
-----------------------------------------------------------------------------------*/
class Refyn_Search_Machine_Learning_Tab extends Refyn_Search_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'refyn_search_machine_learning_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/machine-learning.php' );
...
global $refyn_search_machine_learning_tab;
$refyn_search_machine_learning_tab = new Refyn_Search_Machine_Learning_Tab();
/** 
 * admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function refyn_search_machine_learning_tab_manager() {
	global $refyn_search_machine_learning_tab;
	$refyn_search_machine_learning_tab->tab_manager();
}
