...
- tab_manager()
-----------------------------------------------------------------------------------*/
class Refyn_Search_option_Tab extends Refyn_Search_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'refyn_search_options_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/options.php' );
...
global $refyn_search_option_tab;
$refyn_search_option_tab = new Refyn_Search_option_Tab();
/** 
 * admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function refyn_search_options_tab_manager() {
	global $refyn_search_option_tab;
	$refyn_search_option_tab->tab_manager();
}
