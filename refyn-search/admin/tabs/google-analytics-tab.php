...
/*-----------------------------------------------------------------------------------
Refyn Search Google Analytics Tab
TABLE OF CONTENTS
- var parent_page
- var position
- var tab_data
...
- tab_manager()
-----------------------------------------------------------------------------------*/
class Refyn_Search_Google_Analytics_Tab extends Refyn_Search_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'refyn_search_google_analytics_tab_manager',
		);
...
global $refyn_search_google_analytics_tab;
$refyn_search_google_analytics_tab = new Refyn_Search_Google_Analytics_Tab();
/** 
 * admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function refyn_search_google_analytics_tab_manager() {
	global $refyn_search_google_analytics_tab;
	$refyn_search_google_analytics_tab->tab_manager();
}
