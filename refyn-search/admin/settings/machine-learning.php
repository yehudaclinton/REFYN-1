...
- init_form_fields()
-----------------------------------------------------------------------------------*/
class Refyn_Search_Machine_Learning extends Refyn_Search_Admin_UI
{
	/**
	 * @var string
	 */
	private $parent_tab = 'machine_learning';
	/**
	 * @var array
	 */
	private $subtab_data;
	 ...
	 */
	public $form_key = 'refyn_search_machine_learning';
	/**
	 * @var string
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Keyword successfully saved.', 'refyn' ),
				'error_message'		=> __( 'Error: Keyword can not save.', 'refyn' ),
				'reset_message'		=> __( 'Keyword successfully reseted.', 'refyn' ),
			);
	...
	public function subtab_data() {
		$subtab_data = array(
			...
			'label'				=> __( 'Machine Learning', 'refyn' ),
			'callback_function'	=> 'refyn_search_machine_learning_form',
		);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
                ...
                'type' 		=> 'keywords_table',
				'id'		=> 'refyn_search_keywords_table',
           	),
...
global $refyn_search_machine_learning;
$refyn_search_machine_learning = new Refyn_Search_Machine_Learning();
/**
 * refyn_search_global_settings_form()
 * Define the callback function to show subtab content
 */
function refyn_search_machine_learning_form() {
	global $refyn_search_machine_learning;
	$refyn_search_machine_learning->settings_form();
}
