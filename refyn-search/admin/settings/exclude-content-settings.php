...
- init_form_fields()
-----------------------------------------------------------------------------------*/
class REFYN_Exclude_Content_Settings extends Refyn_Search_Admin_UI
{
	 ...
	 */
	public $form_key = 'refyn_exclude_contents_settings';
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Exclude Content Settings successfully saved.', 'refyn' ),
				'error_message'		=> __( 'Error: Exclude Content Settings can not save.', 'refyn' ),
				'reset_message'		=> __( 'Exclude Content Settings successfully reseted.', 'refyn' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'label'				=> __( 'Exclude Content', 'refyn' ),
			'callback_function'	=> 'refyn_exclude_content_settings_form',
		);
	...
	public function init_form_fields() {
		...
		if ($results_p_tags) {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' 		=> __( 'Exclude From Refyn Search', 'refyn' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Exclude Products', 'refyn' ),
				'id' 		=> 'refyn_search_exclude_products',
				'type' 		=> 'multiselect',
				'placeholder' => __( 'Choose Products', 'refyn' ),
			...
			array(  
				'name' 		=> __( 'Exclude Product Categories', 'refyn' ),
				'id' 		=> 'refyn_search_exclude_p_categories',
				'type' 		=> 'multiselect',
				'placeholder' => __( 'Choose Product Categories', 'refyn' ),
				'css'		=> 'width:600px; min-height:80px;',
				'options'	=> $all_p_categories,
			),
			array(  
				'name' 		=> __( 'Exclude Product Tags', 'refyn' ),
				'id' 		=> 'refyn_search_exclude_p_tags',
				'type' 		=> 'multiselect',
				'placeholder' => __( 'Choose Product Tags', 'refyn' ),
				'css'		=> 'width:600px; min-height:80px;',
				'options'	=> $all_p_tags,
			),
			array(  
				'name' 		=> __( 'Exclude Posts', 'refyn' ),
				'id' 		=> 'refyn_search_exclude_posts',
				'type' 		=> 'multiselect',
				'placeholder' => __( 'Choose Posts', 'refyn' ),
				'css'		=> 'width:600px; min-height:80px;',
				'options'	=> $all_posts,
			),
			array(  
				'name' 		=> __( 'Exclude Pages', 'refyn' ),
				'id' 		=> 'refyn_search_exclude_pages',
				'type' 		=> 'multiselect',
				'placeholder' => __( 'Choose Pages', 'refyn' ),
				'css'		=> 'width:600px; min-height:80px;',
				'options'	=> $all_pages,
			),
...
global $refyn_exclude_content_settings;
$refyn_exclude_content_settings = new REFYN_Exclude_Content_Settings();
/** 
 * refyn_exclude_content_settings_form()
 * Define the callback function to show subtab content
 */
function refyn_exclude_content_settings_form() {
	global $refyn_exclude_content_settings;
	$refyn_exclude_content_settings->settings_form();
}
