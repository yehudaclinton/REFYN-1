...
- init_form_fields()
-----------------------------------------------------------------------------------*/
class Refyn_Search_Stopwords extends Refyn_Search_Admin_UI
{
	/**
	 * @var string
	 */
	private $parent_tab = 'stopwords';
	/**
	 * @var array
	 */
	private $subtab_data;
	 ...
	 */
	public $form_key = 'refyn_search_stopwords';
	/**
	 * @var string
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Stopword successfully saved.', 'refyn' ),
				'error_message'		=> __( 'Error: Stopword can not save.', 'refyn' ),
				'reset_message'		=> __( 'Stopwords successfully reseted.', 'refyn' ),
			);
	...
	public function subtab_data() {
		$subtab_data = array(
			...
			'callback_function'	=> 'refyn_search_stopwords_form',
		);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
                ...
                'type' 		=> 'stopwords_table',
				'id'		=> 'refyn_search_stopwords_table_text',
           	),
...
$refyn_search_stopwords = new Refyn_Search_Stopwords();
/**
 * refyn_search_global_settings_form()
 * Define the callback function to show subtab content
 */
function refyn_search_stopwords_form() {
	global $refyn_search_stopwords;
