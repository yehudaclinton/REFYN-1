...
- blue_message_box()
-----------------------------------------------------------------------------------*/
class Refyn_Search_Admin_UI
{
	/**
	 * @var string
	 * You must change to correct plugin name that you are working
	 */
	public $plugin_name = 'woo_refyn_search';
	 ...
	 */
	public $class_name = 'Refyn_Search';
	
	/**
	 * @var string

	 */
	public $pro_plugin_page_url = 'https://refyn.org';
	...
	public function plugin_extension_start( $echo = true ) {
		$output = '<div id="refyn_plugin_panel_container">';
		$output .= '<div id="refyn_plugin_panel_fields">';
	...
	public function plugin_extension_end( $echo = true ) {
		$output = '</div>';
		$output .= '<div id="refyn_plugin_panel_upgrade_area">';
		$output .= '<div id="refyn_plugin_panel_extensions">';
	...
	public function upgrade_top_message( $echo = false, $setting_id = '' ) {
		/*$upgrade_top_message = sprintf( '<div class="pro_feature_top_message">' 
			. __( 'Settings inside this yellow border are %s Features.', 'refyn' ) 
			. '<br />' 
			. __( 'Upgrade to the <a href="%s" target="_blank">%s</a> to activate these settings.', 'refyn' ) 
			. '</div>'
			, apply_filters( $this->plugin_name . '_' . $setting_id . '_pro_version_name', apply_filters( $this->plugin_name . '_pro_version_name', __( 'Pro Version', 'refyn' ) ) )
	...
	public function blue_message_box( $message = '', $width = '600px' ) {
		$message = '<div class="refynrev_blue_message_box_container" style="width:'.$width.'"><div class="refynrev_blue_message_box">' . $message . '</div></div>';
