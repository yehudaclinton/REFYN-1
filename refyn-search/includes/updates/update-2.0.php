...
$exclude_products = get_option('refyn_search_exclude_products', '');
if ($exclude_products !== false) {
	...
	update_option('refyn_search_exclude_products', (array) $exclude_products);
} else {
	update_option('refyn_search_exclude_products', array());
}
