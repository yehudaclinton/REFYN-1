...
class REFYN_PostMeta_Data
{
	...
	/**
	 * Refyn Search Post Meta Table - set table name
	 *
	 * @return void
	 */
	...
	/**
	 * Get Refyn Search Array Items Exclude by Out of Stock
	 */
	...
	/**
	 * Delete Refyn Search Post Metas
	 */
...
global $refyn_postmeta_data;
$refyn_postmeta_data = new REFYN_PostMeta_Data();
